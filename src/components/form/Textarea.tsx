    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <textarea
          ...
          className={cn(
            "min-h-[120px] resize-y rounded-md border border-neutral-300 bg-sidebar px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-neutral-400",
